        ...
        h.postDelayed(new Runnable() {
           public void run() {
               ...
               if(checkPillarPosition(pillar1.getY())) {
                   ...
                   pillar11.setX(pillarPlacementX(pillar11.getX()));
                   pillar11.setY(pillarPlacementY(pillar11.getY()));
               } else if(checkPillarPosition(pillar13.getY())) {
                   sendViewToBack(pillar13);
                   pillar11.setX(pillarPlacementX(pillar12.getX()));
                   pillar11.setY(pillarPlacementY(pillar12.getY()));
               } else if(checkPillarPosition(pillar14.getY())) {
                   sendViewToBack(pillar14);
                   pillar11.setX(pillarPlacementX(pillar13.getX()));
                   pillar11.setY(pillarPlacementY(pillar13.getY()));
               } else if(checkPillarPosition(pillar15.getY())) {
                   sendViewToBack(pillar15);
                   pillar11.setX(pillarPlacementX(pillar14.getX()));
                   pillar11.setY(pillarPlacementY(pillar14.getY()));
               } else if(checkPillarPosition(pillar16.getY())) {
                   sendViewToBack(pillar16);
                   pillar11.setX(pillarPlacementX(pillar15.getX()));
                   pillar11.setY(pillarPlacementY(pillar15.getY()));
               } else if(checkPillarPosition(pillar17.getY())) {
                   sendViewToBack(pillar17);
                   pillar11.setX(pillarPlacementX(pillar16.getX()));
                   pillar11.setY(pillarPlacementY(pillar16.getY()));
               } else if(checkPillarPosition(pillar18.getY())) {
                   sendViewToBack(pillar18);
                   pillar11.setX(pillarPlacementX(pillar17.getX()));
                   pillar11.setY(pillarPlacementY(pillar17.getY()));
               } else if(checkPillarPosition(pillar19.getY())) {
                   sendViewToBack(pillar19);
                   pillar11.setX(pillarPlacementX(pillar18.getX()));
                   pillar11.setY(pillarPlacementY(pillar18.getY()));
               } else if(checkPillarPosition(pillar20.getY())) {
                   sendViewToBack(pillar20);
                   pillar11.setX(pillarPlacementX(pillar19.getX()));
                   pillar11.setY(pillarPlacementY(pillar19.getY()));
               }
               ...
               if(Rect.intersects(ballRect, pillar1Rect)) {
                   ...
                   pillarTop2.setX(pillar1.getX() + 10.5f);
                   pillarTop2.setY(pillar1.getY() + 10.5f);
                   pillarTop3.setX(pillar20.getX() + 10.5f);
                   pillarTop3.setY(pillar20.getY() + 10.5f);
                   pillarTop4.setX(pillar19.getX() + 10.5f);
                   pillarTop4.setY(pillar19.getY() + 10.5f);
                   pillarTop5.setX(pillar18.getX() + 10.5f);
                   pillarTop5.setY(pillar18.getY() + 10.5f);
                   pillarTop6.setX(pillar17.getX() + 10.5f);
                   pillarTop6.setY(pillar17.getY() + 10.5f);
                   ...
                   pillarTop4.setX(pillar20.getX() + 10.5f);
                   pillarTop4.setY(pillar20.getY() + 10.5f);
                   pillarTop5.setX(pillar19.getX() + 10.5f);
                   pillarTop5.setY(pillar19.getY() + 10.5f);
                   pillarTop6.setX(pillar18.getX() + 10.5f);
                   pillarTop6.setY(pillar18.getY() + 10.5f);
                   ...
                   pillarTop1.setX(pillar18.getX() + 10.5f);
                   pillarTop1.setY(pillar18.getY() + 10.5f);
                   ...
                   pillarTop1.setX(pillar19.getX() + 10.5f);
                   pillarTop1.setY(pillar19.getY() + 10.5f);
                   pillarTop2.setX(pillar18.getX() + 10.5f);
                   pillarTop2.setY(pillar18.getY() + 10.5f);
                   pillarTop3.setX(pillar17.getX() + 10.5f);
                   pillarTop3.setY(pillar17.getY() + 10.5f);
               } else if(Rect.intersects(ballRect, pillar19Rect)) {
                   pillarTop1.setX(pillar20.getX() + 10.5f);
                   pillarTop1.setY(pillar20.getY() + 10.5f);
                   pillarTop2.setX(pillar19.getX() + 10.5f);
                   pillarTop2.setY(pillar19.getY() + 10.5f);
                   pillarTop3.setX(pillar18.getX() + 10.5f);
                   pillarTop3.setY(pillar18.getY() + 10.5f);
               } else if(Rect.intersects(ballRect, pillar20Rect)) {
                   pillarTop1.setX(pillar1.getX() + 10.5f);
                   pillarTop1.setY(pillar1.getY() + 10.5f);
                   pillarTop2.setX(pillar20.getX() + 10.5f);
                   pillarTop2.setY(pillar20.getY() + 10.5f);
                   pillarTop3.setX(pillar19.getX() + 10.5f);
                   pillarTop3.setY(pillar19.getY() + 10.5f);
               }
